...
@CucumberOptions(
		...
		features = "src/test/resources/features/",//here we sepcify the path for the feature file

		glue = "com/hrms.steps",// here we locate the location of of the steps classes( java files)

		dryRun = true,// if true, it will scan for errore before opening the browser
		...
		plugin = { "pretty",//prints the gerkin words in the conceol
				"html:target/cucumber-default-report",//creates basick html report in specific location
